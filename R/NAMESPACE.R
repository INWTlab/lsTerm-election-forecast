...
#' @importFrom ggplot2 ggplot geom_ribbon aes geom_line geom_vline xlim annotate geom_point ylim scale_fill_manual geom_point scale_color_manual scale_y_continuous
#' @importFrom httr GET
